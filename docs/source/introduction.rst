...
On distributed HTC systems, jobs may execute at different institutions/sites with different processor architectures, operating systems, hardware configurations, and software environments. As a result, applications must be designed to run reliably across a diverse set of resources.
